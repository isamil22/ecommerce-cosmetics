...
public class CommentController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority('COMMENT:VIEW') or hasAuthority('COMMENT:EDIT') or hasAuthority('ROLE_ADMIN') or hasAuthority('ROLE_MANAGER')")
    ...
    @PreAuthorize("hasAuthority('COMMENT:DELETE') or hasAuthority('COMMENT:EDIT') or hasAuthority('ROLE_ADMIN') or hasAuthority('ROLE_MANAGER')")
