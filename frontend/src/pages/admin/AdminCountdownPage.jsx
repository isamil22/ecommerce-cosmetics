...
const AdminCountdownPage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        saveCountdown(countdownData)
            .then(() => {
                setMessage(t('countdownPage.messages.saveSuccess'));
                setTimeout(() => setMessage(''), 3000);
            })
            .catch(() => {
                setMessage(t('countdownPage.messages.saveError'));
                setTimeout(() => setMessage(''), 3000);
            });
    };
    ...
    return (
        <div className="p-6">
            <h1 className="text-3xl font-bold mb-6">{t('countdownPage.title')}</h1>
            ...
            <form onSubmit={handleSubmit} className="max-w-6xl mx-auto space-y-8">
                ...
                <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-indigo-50 p-6 rounded-lg shadow-md border-2 border-purple-200">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.themes.title')}</h2>

                    {/* Theme Selection */}
                    <div className="mb-6">
                        <label className="block text-sm font-medium text-gray-700 mb-3">{t('countdownPage.sections.themes.label')}</label>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {/* Dark Premium Theme */}
                            <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === 'darkPremium'
                                ...
                                <h3 className="font-semibold text-gray-800">{t('countdownPage.sections.themes.presets.darkPremium.name')}</h3>
                                <p className="text-sm text-gray-600">{t('countdownPage.sections.themes.presets.darkPremium.description')}</p>
                            </div>

                            {/* Light Professional Theme */}
                            <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === 'lightProfessional'
                                ...
                                <h3 className="font-semibold text-gray-800">{t('countdownPage.sections.themes.presets.lightProfessional.name')}</h3>
                                <p className="text-sm text-gray-600">{t('countdownPage.sections.themes.presets.lightProfessional.description')}</p>
                            </div>

                            {/* Modern Gradient Theme */}
                            <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === 'modernGradient'
                                ...
                                <h3 className="font-semibold text-gray-800">{t('countdownPage.sections.themes.presets.modernGradient.name')}</h3>
                                <p className="text-sm text-gray-600">{t('countdownPage.sections.themes.presets.modernGradient.description')}</p>
                            </div>

                            {/* Elegant Minimal Theme */}
                            <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === 'elegantMinimal'
                                ...
                                <h3 className="font-semibold text-gray-800">{t('countdownPage.sections.themes.presets.elegantMinimal.name')}</h3>
                                <p className="text-sm text-gray-600">{t('countdownPage.sections.themes.presets.elegantMinimal.description')}</p>
                            </div>

                            {/* Vibrant Energy Theme */}
                            <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === 'vibrantEnergy'
                                ...
                                <h3 className="font-semibold text-gray-800">{t('countdownPage.sections.themes.presets.vibrantEnergy.name')}</h3>
                                <p className="text-sm text-gray-600">{t('countdownPage.sections.themes.presets.vibrantEnergy.description')}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex-1">
                            <p className="text-gray-700 mb-2">
                                <strong>{t('countdownPage.sections.themes.description')}</strong>
                            </p>
                        </div>
                        <div className="ml-6">
                            <button
                            ...
                            >
                                {t('countdownPage.sections.themes.applyButton')}
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
                        <h4 className="font-semibold text-gray-800 mb-2">{t('countdownPage.sections.themes.selectedPreview')}</h4>
                        <div className="text-sm text-gray-600">
                            {selectedTheme === 'darkPremium' && (
                                <div>
                                    <p><strong>{t('countdownPage.sections.themes.presets.darkPremium.name')}:</strong> {t('countdownPage.sections.themes.presets.darkPremium.preview')}</p>
                                </div>
                            )}
                            {selectedTheme === 'lightProfessional' && (
                                <div>
                                    <p><strong>{t('countdownPage.sections.themes.presets.lightProfessional.name')}:</strong> {t('countdownPage.sections.themes.presets.lightProfessional.preview')}</p>
                                </div>
                            )}
                            {selectedTheme === 'modernGradient' && (
                                <div>
                                    <p><strong>{t('countdownPage.sections.themes.presets.modernGradient.name')}:</strong> {t('countdownPage.sections.themes.presets.modernGradient.preview')}</p>
                                </div>
                            )}
                            {selectedTheme === 'elegantMinimal' && (
                                <div>
                                    <p><strong>{t('countdownPage.sections.themes.presets.elegantMinimal.name')}:</strong> {t('countdownPage.sections.themes.presets.elegantMinimal.preview')}</p>
                                </div>
                            )}
                            {selectedTheme === 'vibrantEnergy' && (
                                <div>
                                    <p><strong>{t('countdownPage.sections.themes.presets.vibrantEnergy.name')}:</strong> {t('countdownPage.sections.themes.presets.vibrantEnergy.preview')}</p>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.basic.title')}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="title" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.title.label')}</label>
                            <input type="text" id="title" value={title} onChange={e => setTitle(e.target.value)}
                                placeholder={t('countdownPage.sections.basic.fields.title.placeholder')}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="endDate" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.endDate.label')}</label>
                            <input type="datetime-local" id="endDate" value={endDate} onChange={e => setEndDate(e.target.value)}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="subtitle" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.subtitle.label')}</label>
                            <input type="text" id="subtitle" value={subtitle} onChange={e => setSubtitle(e.target.value)}
                                placeholder={t('countdownPage.sections.basic.fields.subtitle.placeholder')}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="packName" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.packName.label')}</label>
                            <input type="text" id="packName" value={packName} onChange={e => setPackName(e.target.value)}
                                placeholder={t('countdownPage.sections.basic.fields.packName.placeholder')}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="urgentMessage" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.urgentMessage.label')}</label>
                            <input type="text" id="urgentMessage" value={urgentMessage} onChange={e => setUrgentMessage(e.target.value)}
                                placeholder={t('countdownPage.sections.basic.fields.urgentMessage.placeholder')}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="expiredMessage" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.basic.fields.expiredMessage.label')}</label>
                            <input type="text" id="expiredMessage" value={expiredMessage} onChange={e => setExpiredMessage(e.target.value)}
                                placeholder={t('countdownPage.sections.basic.fields.expiredMessage.placeholder')}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                    </div>
                    <div className="mt-4">
                        <div className="flex items-center">
                            ...
                            <label htmlFor="enabled" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.basic.fields.enabled.label')}</label>
                        </div>
                    </div>
                </div>
                ...
                {/* Color Settings */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.colors.title')}</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            <label htmlFor="backgroundColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.background')}</label>
                            <input type="color" id="backgroundColor" value={backgroundColor} onChange={e => setBackgroundColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="textColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.text')}</label>
                            <input type="color" id="textColor" value={textColor} onChange={e => setTextColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="borderColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.border')}</label>
                            <input type="color" id="borderColor" value={borderColor} onChange={e => setBorderColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="timerBoxColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.timerBox')}</label>
                            <input type="color" id="timerBoxColor" value={timerBoxColor} onChange={e => setTimerBoxColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="timerTextColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.timerText')}</label>
                            <input type="color" id="timerTextColor" value={timerTextColor} onChange={e => setTimerTextColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="urgentBgColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.urgentBg')}</label>
                            <input type="color" id="urgentBgColor" value={urgentBgColor} onChange={e => setUrgentBgColor(e.target.value)}
                                className="mt-1 block w-full h-10 rounded-md border-gray-300 shadow-sm" />
                        </div>
                        <div>
                            <label htmlFor="urgentTextColor" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.colors.fields.urgentText')}</label>
                ...
                {/* Display Settings */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.display.title')}</h2>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <div className="flex items-center">
                            <input type="checkbox" id="showDays" checked={showDays} onChange={e => setShowDays(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showDays" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showDays')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="showHours" checked={showHours} onChange={e => setShowHours(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showHours" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showHours')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="showMinutes" checked={showMinutes} onChange={e => setShowMinutes(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showMinutes" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showMinutes')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="showSeconds" checked={showSeconds} onChange={e => setShowSeconds(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showSeconds" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showSeconds')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="showPackName" checked={showPackName} onChange={e => setShowPackName(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showPackName" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showPackName')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="showSubtitle" checked={showSubtitle} onChange={e => setShowSubtitle(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="showSubtitle" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.display.fields.showSubtitle')}</label>
                        </div>
                    </div>
                </div>
                ...
                {/* Animation Settings */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.animation.title')}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="flex items-center">
                            <input type="checkbox" id="enablePulse" checked={enablePulse} onChange={e => setEnablePulse(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="enablePulse" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.animation.fields.pulse')}</label>
                        </div>
                        <div className="flex items-center">
                            <input type="checkbox" id="enableBounce" checked={enableBounce} onChange={e => setEnableBounce(e.target.checked)}
                                className="h-4 w-4 rounded border-gray-300 text-pink-600 focus:ring-pink-500" />
                            <label htmlFor="enableBounce" className="ml-2 block text-sm text-gray-900">{t('countdownPage.sections.animation.fields.bounce')}</label>
                        </div>
                        <div>
                            <label htmlFor="urgentThreshold" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.animation.fields.threshold')}</label>
                ...
                {/* Layout Settings */}
                <div className="bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-xl font-bold mb-4 text-gray-800">{t('countdownPage.sections.layout.title')}</h2>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                            <label htmlFor="borderRadius" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.layout.fields.borderRadius')}</label>
                            <input type="number" id="borderRadius" value={borderRadius} onChange={e => setBorderRadius(parseInt(e.target.value))}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="padding" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.layout.fields.padding')}</label>
                            <input type="number" id="padding" value={padding} onChange={e => setPadding(parseInt(e.target.value))}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="fontSize" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.layout.fields.fontSize')}</label>
                            <input type="number" id="fontSize" value={fontSize} onChange={e => setFontSize(parseInt(e.target.value))}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" />
                        </div>
                        <div>
                            <label htmlFor="timerFontSize" className="block text-sm font-medium text-gray-700">{t('countdownPage.sections.layout.fields.timerFontSize')}</label>
