...
import { getUserOrders, isAuthenticated } from '../api/apiService';
    ...
    if (isGuest) {
        return (
            <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-800 mb-2">تسجيل الدخول مطلوب / Connexion requise</h3>
                <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    يجب عليك تسجيل الدخول أو إنشاء حساب لعرض سجل طلباتك.
                    <br />
                    Vous devez vous connecter ou créer un compte pour voir l'historique de vos commandes.
                </p>
                <div className="flex justify-center gap-4">
                    <Link
                        to="/auth"
                        className="px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-xl hover:from-pink-600 hover:to-purple-700 transition shadow-lg"
                    >
