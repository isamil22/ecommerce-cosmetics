            ...
            <div className="relative bg-gradient-to-r from-pink-500 via-purple-600 to-pink-600 py-16">
                ...
                <div className="relative container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-white text-opacity-90 max-w-2xl mx-auto">
                        إدارة طلباتك، مراجعاتك، وإعدادات حسابك / Gérer vos commandes, avis et paramètres de compte
                    </p>
                </div>
            </div>
                            ...
                            <div className="flex-1 text-center md:text-left">
                                ...
                                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                                        ...
                                        حساب موثوق / Compte Vérifié
                                    </span>
                                    <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">
                                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        عضو منذ {new Date(userProfile.createdAt).getFullYear()} / Membre depuis {new Date(userProfile.createdAt).getFullYear()}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg border border-pink-100 overflow-hidden">
                            <div className="bg-gradient-to-r from-green-500 to-green-600 p-6">
                                <h3 className="text-xl font-bold text-white flex items-center">
                                    ...
                                    تحتاج مساعدة؟ / Besoin d'aide ?
                                </h3>
                            </div>
                            <div className="p-6">
                                <p className="text-gray-600 mb-6 text-center">
                                    تواصل مع فريق الدعم مباشرة عبر الواتساب لأي استفسار حول طلباتك أو حسابك.
                                    <br />
                                    Contactez notre équipe de support directement sur WhatsApp pour toute question concernant vos commandes ou votre compte.
                                </p>
                                <div className="text-center">
                                    ...
                                    >
                                        ...
                                        <span>تواصل عبر الواتساب / Discuter sur WhatsApp</span>
                                    </a>
                                </div>
                            </div>
                        </div>
