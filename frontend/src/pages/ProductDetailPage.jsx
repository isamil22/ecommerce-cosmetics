...
const ProductDetailPage = ({ fetchCartCount, isAuthenticated }) => {
    ...
    const handleAddToCart = async () => {
        ...
        trackEvent('AddToCart', {
            ...
            content_type: 'product',
            value: activeVariant ? activeVariant.price : product.price,
            currency: 'USD'
        });
    ...
    const handleOrderNow = async () => {
        ...
        ReactGA.event({
            ...
            label: 'Direct Order: ' + product.name,
            value: price * quantity
        });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-pink-50">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-pink-100 via-purple-50 to-blue-100 opacity-70"></div>
                <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-pink-300 to-purple-300 rounded-full -translate-y-48 translate-x-48 opacity-40 blur-3xl animate-pulse"></div>
                <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-blue-300 to-pink-300 rounded-full translate-y-40 -translate-x-40 opacity-40 blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>

                <div className="relative z-10 w-full px-2 py-4 lg:py-6 container mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 xl:gap-8 content-spacing-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <div className="relative overflow-hidden rounded-xl shadow-xl bg-white p-2 max-w-2xl mx-auto">
                                    ...
                                    {product.images && product.images.map((img, index) =>
                                        img && img.includes('youtube.com/embed') ? (
                                            <div
                                                ...
                                                className={`flex-shrink-0 w-24 h-24 rounded-xl cursor-pointer border-3 flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 transition-all duration-300 transform hover:scale-110 ${selectedImage === img
                                            ...
                                            <img
                                                ...
                                                className={`flex-shrink-0 w-24 h-24 object-cover rounded-xl cursor-pointer border-3 transition-all duration-300 transform hover:scale-110 ${selectedImage === img
                                                    ? 'border-pink-500 ring-4 ring-pink-200 shadow-lg'
                                                    : 'border-gray-300 hover:border-pink-300'
                                                    }`}
                                                onClick={() => setSelectedImage(img)}
                        ...
                        <div className="space-y-4 max-w-2xl mx-auto lg:max-w-none">
                            ...
                            <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 lg:p-5 shadow-lg border border-gray-200">
                                {/* Product Title - Highest Priority */}
                                <div className="mb-5">
                                    <h1 className="text-2xl lg:text-4xl font-extrabold bg-gradient-to-r from-gray-900 via-pink-600 to-purple-600 bg-clip-text text-transparent mb-3 leading-tight drop-shadow-sm">
                                        {product.name}
                                    </h1>
                                    ...
                                    <div className="flex items-center gap-3 mb-4">
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-2xl lg:text-4xl font-black text-pink-600">${displayPrice}</span>
                            ...
                            {product.hasVariants && (
                                <div className="bg-white/95 backdrop-blur-sm rounded-xl p-4 shadow-lg border border-gray-200 compact-card">
                                            ...
                                            <div className="flex gap-2 flex-wrap">
                                                {vt.options && vt.options.map(option => option && (
                                                    <button
                                                        ...
                                                        className={`px-4 py-2.5 border-2 rounded-lg font-semibold transition-all duration-200 text-sm min-w-[60px] ${selectedOptions[vt.name] === option
                            ...
                            <div ref={addToCartRef} className="bg-gradient-to-br from-white to-pink-50/80 backdrop-blur-md p-4 lg:p-5 rounded-2xl shadow-xl border border-pink-200 compact-section ring-1 ring-pink-100">
                                ...
                                <div className="space-y-2.5">
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-gradient-to-r from-green-500 via-green-600 to-emerald-700 text-white font-bold py-4 px-6 rounded-xl hover:from-green-600 hover:to-emerald-800 disabled:bg-gray-400 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-2xl transform hover:-translate-y-1 active:scale-95 ring-2 ring-green-200 ring-offset-2"
                                    ...
                                    <button
                                        ...
                                        className="w-full bg-white text-pink-600 font-bold py-3.5 px-6 rounded-xl border-2 border-pink-100 hover:border-pink-300 hover:bg-pink-50 disabled:bg-gray-100 disabled:text-gray-400 transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg active:scale-95"
                                        disabled={displayStock <= 0}
                                    >
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="w-full px-0 py-0">
                <div className="bg-gradient-to-br from-white via-blue-50 to-purple-50 w-full py-8 lg:py-10">
                    <div className="container mx-auto px-4">
                        <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-4 lg:p-8 shadow-lg border border-white/50 max-w-5xl mx-auto">
                            <div className="flex flex-col md:flex-row items-center mb-6 gap-4 text-center md:text-left">
                                ...
                                <div>
                                    <h2 className="text-xl md:text-3xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
                                        وصف المنتج / Product Description
                                    </h2>
                                    <p className="text-gray-600 mt-2 text-sm md:text-base">تفاصيل شاملة عن المنتج / Comprehensive product details</p>
                                </div>
                            </div>

                            <div className="prose prose-lg max-w-none">
                                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-white/50">
                                    <div dangerouslySetInnerHTML={{ __html: product.description }} />
                                </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-green-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                            <div className="flex items-start gap-3 md:gap-4">
                                                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl flex items-center justify-center text-white text-lg md:text-xl">
                                                    ✓
                                                </div>
                                                <div>
                                                    <h5 className="text-base md:text-lg font-bold text-green-700 mb-1 md:mb-2">منتجات أصلية / Authentic Products</h5>
                                        ...
                                        <div className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                            <div className="flex items-start gap-3 md:gap-4">
                                                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-cyan-500 rounded-xl flex items-center justify-center text-white text-lg md:text-xl">
                                                    🚚
                                                </div>
                                                <div>
                                                    <h5 className="text-base md:text-lg font-bold text-blue-700 mb-1 md:mb-2">شحن سريع / Fast Shipping</h5>
                                        ...
                                        <div className="group bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-purple-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                            <div className="flex items-start gap-3 md:gap-4">
                                                <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-purple-400 to-pink-500 rounded-xl flex items-center justify-center text-white text-lg md:text-xl">
                                                    ↩️
                                                </div>
                                                <div>
                                                    <h5 className="text-base md:text-lg font-bold text-purple-700 mb-1 md:mb-2">إرجاع سهل / Easy Returns</h5>
            ...
            <div className="w-full px-0 py-0">
                <div className="bg-gradient-to-br from-yellow-50 via-orange-50 to-red-50 w-full py-8 lg:py-10 border-t border-white">
                    <div className="container mx-auto px-4">
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-4 md:p-8 shadow-lg border border-yellow-200/50 max-w-5xl mx-auto">
                            <div className="flex flex-col md:flex-row items-center justify-between mb-8 gap-6 text-center md:text-left">
                                <div className="flex flex-col md:flex-row items-center gap-4">
                                    ...
                                    <div>
                                        <h2 className="text-xl md:text-3xl font-extrabold bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent">
                            ...
                            {product.comments && product.comments.length > 0 ? (
                                <div className="space-y-6 mb-8">
                                    {product.comments && product.comments.slice(0, 3).map(comment => comment && (
                                        <div key={comment.id} className="bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-lg border-l-4 border-yellow-400 hover:shadow-xl transition-all duration-300">
            ...
            <div className="container-xl my-4 px-2">
                <div className="bg-gradient-to-br from-green-50 via-blue-50 to-indigo-50 rounded-xl p-4 shadow border border-green-200/50 max-w-4xl mx-auto">
            ...
            <div className="container-xl my-6 px-2">
                <div className="bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900 rounded-2xl p-6 lg:p-8 text-white relative overflow-hidden max-w-6xl mx-auto">
                    {/* Background Pattern */}
