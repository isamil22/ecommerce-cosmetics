    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="max-w-lg mx-auto text-center">
                <h1 className="text-4xl font-bold text-gray-800 mb-4">تواصل معنا / Contactez-nous</h1>
                <p className="text-lg text-gray-600 mb-8">
                    هل لديك سؤال؟ أسرع طريقة للوصول إلينا هي عبر الواتساب. اضغط على الزر أدناه لبدء محادثة مع فريق الدعم.
                    <br />
                    Une question ? Le moyen le plus rapide de nous joindre est via WhatsApp. Cliquez sur le bouton ci-dessous pour discuter avec notre équipe.
                </p>
                ...
                >
                    ...
                    تواصل معنا عبر الواتساب / Discuter sur WhatsApp
                </a>
            </div>
        </div>
    );
